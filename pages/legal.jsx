      ...
      <section id="legal" className="bg-gray-900 min-h-screen">
        ...
        <div className="flex flex-col justify-start px-5 text-white">
          <p className="text-gray-300 italic">
            ...
            is published under the provisions of Rule 3 (1) of the Information
            Technology (Intermediaries Guidelines) Rules 2011, which mandates
            for publishing of privacy policy and terms and conditions for access
            or usage of the resources provided herein. This electronic record is
                ...
                <ul className="list-disc px-10 space-y-2">
                  <li>
                    <p>
                      ...
                      available for your Service Provided by us, You may not use
                      the Services for production/patent/commercial use.
                    </p>
                  </li>
                  <li>
                    ...
                    <ul className="list-[lower-roman] pl-8 space-y-2 text-gray-200">
                      ...
                      <li>
                        ...
                        disable, overburden, or impair any our service, or the
                        network(s) connected to any our service, or interfere
                        with any other party’s use and enjoyment of any
                        Services.
                      </li>
                    </ul>
                  </li>
                ...
                <ul className="list-disc px-10 space-y-4">
                  <li>
                    <p>
                      ...
                      associated possession or usage rights.
                      <br />
                      We may provide you with Our Software for use outside the
                      Developer Services and with (1) the Developer Services or
                      (2) programs you develop using the Developer Services. If
                      Our Software is provided with its own license terms, those
                      license terms control provided that they are modified by
                      the preceding portion of this Section 2(a) in case of
                      conflict. If the Our Software does not have its own
                      license terms, then you may install and use any number of
                      copies of the Our Software to design and develop your
                      applications. This subsection does not apply to Our
                      Software addressed in subsection (b) below.
                    </p>
                  </li>
                  <li>
                    <p>
                      ...
                      terms is marked as “sample” or “example,” then you may use
                      it under the terms of the GNU General Public License 3.0
                      or GNU Affero General Public License 3.0 only.
                    </p>
                  </li>
                  <li>
                    <p>
                      c. Scope of rights. All Our Software is the copyrighted
                      works. All Our Software are licensed not sold and may not
                      be transferred unless specified otherwise in any license
                  ...
                  <li>
                    <p>
                      ...
                      you to interact with the Service under terms of this
          ...
          <section id="privacy-policy" className="py-10">
            ...
            <p className="italic -mt-3">
              ...
              protect personal information that we collect from you, the
              end-user of the Our website, apps, and services.
            </p>

            <ul className="list-decimal px-8 py-3 space-y-4 text-slate-100">
              <li>
                We do not sell or rent anonymized personal information to third
                party entities, we collect Some Public Information about you
                which is Specified in the Websites and/or the Services to
                analyse the Interest of users in the Website and/or the
                Services, No other data is stored on Our servers and/or
                Databases.
              </li>
              ...
              <li>
                The website and/or our Services uses a small tracking code
                called &quot;Analytics&quot;. This information is used to
                inter-alia deliver our web pages and/or services to you upon
                request, to tailor our services to the interests of our users,
                to measure traffic within our services, to improve the quality,
                functionality, and interactivity, and let us know the geographic
                locations from where our users or visitors come.
              </li>
              ...
              <li>
                ...
                uses), We Solemnly Responsible for any Misuse or Illegal Actions
                which were Done with the Collecting the Information about you.
              </li>
            </ul>
          </section>
        </div>
